...
static inline __device__ int roundf(float a) { return int(a+0.5f); }
static inline __device__ unsigned int __float2uint_ru(float x) { return unsigned(x + 1.0f); }
static inline __device__ float log2f(float x) { return __builtin_log2f(x); }
static inline __device__ int __clz(int x) { return __builtin_clz(x); }
static inline __device__ long long __clzll(long long x) { return __builtin_clzll(x); }
...
static inline __device__ float __log2f(float x) { return __nvvm_lg2_approx_f(x); }
static inline __device__ unsigned __shfl_down_sync(unsigned mask, unsigned int var, unsigned int delta) { return __nvvm_shfl_sync_down_i32(mask, var, delta, 32); }
